...
export default function InventoryStats({ data, isLoading = false }: InventoryStatsProps) {
  const { t } = useLanguage();
  ...
  const stats = [
    ...
    },
    {
      ...
      icon: DollarSign,
      description: t('dashboard.stats.totalValue.description'),
    ...
    {
      title: t('dashboard.stats.outOfStock.title'),
      value: formatNumber(data.outOfStock),
      icon: XCircle,
      description: t('dashboard.stats.outOfStock.description'),
      color: "text-red-500",
    },
  ];
