      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="wow fadeInUp rounded-lg bg-primary/[.03] p-8 shadow-md hover:shadow-lg dark:bg-dark sm:p-10 lg:p-12 xl:p-8 flex flex-col items-center text-center" data-wow-delay=".1s">
            ...
            <h3 className="mb-4 text-xl font-bold text-black dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">Point of Sale (POS)</h3>
            <p className="text-base font-medium text-body-color dark:text-body-color-dark">
              Seamless transactions, real-time sales tracking, and advanced reporting to optimize your business
            </p>
          </div>
          ...
          <div className="wow fadeInUp rounded-lg bg-primary/[.03] p-8 shadow-md hover:shadow-lg dark:bg-dark sm:p-10 lg:p-12 xl:p-8 flex flex-col items-center text-center" data-wow-delay=".15s">
            ...
            <h3 className="mb-4 text-xl font-bold text-black dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">Cloud-Optional ERP</h3>
            <p className="text-base font-medium text-body-color dark:text-body-color-dark">
              Access your business data anytime, anywhere with our secure and scalable cloud infrastructure
            </p>
          </div>
          ...
          <div className="wow fadeInUp rounded-lg bg-primary/[.03] p-8 shadow-md hover:shadow-lg dark:bg-dark sm:p-10 lg:p-12 xl:p-8 flex flex-col items-center text-center" data-wow-delay=".2s">
            ...
            <h3 className="mb-4 text-xl font-bold text-black dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">Analytics & Reports</h3>
            <p className="text-base font-medium text-body-color dark:text-body-color-dark">
              Gain valuable insights with AI-driven analytics and customizable reports
            </p>
          </div>
        </div>
      </div>
